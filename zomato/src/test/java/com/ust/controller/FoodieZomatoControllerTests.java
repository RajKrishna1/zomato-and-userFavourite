...
public class FoodieZomatoControllerTests {
	...
	@Test
	public void testGetRestaurants1() throws Exception {
	...
	@Test
	public void testGetRestaurants2() throws Exception {

		MvcResult result = zomatoMockMVC
				.perform(get("/api/zomatoservice/getRestaurants").header("user-key", "c9125894b0e68ddc365ced057530fb12")
						.param("cityName", "Banglore").param("cuisineName", "Chinese"))
				.andExpect(status().isOk()).andReturn();
		int status = result.getResponse().getStatus();
		assertEquals(200, status);
	}
	@Test
	public void testGetRestaurants3() throws Exception {

		MvcResult result = zomatoMockMVC
				.perform(get("/api/zomatoservice/getRestaurants").header("user-key", "c9125894b0e68ddc365ced057530fb12")
						.param("cityName", "Kochi").param("cuisineName", "Chinese"))
				.andExpect(status().isOk()).andReturn();
		int status = result.getResponse().getStatus();
		assertEquals(200, status);
	}
