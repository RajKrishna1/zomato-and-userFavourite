...
public class FavouriteController {
	 private FavouriteService favouriteService;
	    ...
	    @PostMapping("/add")
	    public ResponseEntity<Favourite> saveFavourite(@RequestBody Favourite favourite)throws RestuarantAlreadyExistsException{
	    	//
	...
	//done
	    ...
	    /* This method fetches a Favourite by its id and returns the respective Favourite */
	    @GetMapping("Favourite/{id}")
	    public ResponseEntity<Favourite> getBlogById(@PathVariable("id") int favouriteId)throws RestuarantNotFoundException {
	...
	//done
	    /* This method deletes a Favourite by its id and returns the deleted Favourite object */
	    @DeleteMapping("Favourite/{id}")
	    public ResponseEntity<Favourite> getfavouriteAfterDeleting(@PathVariable("id") int favouriteId) throws RestuarantNotFoundException, Exception{
	...
	//done
	    /* This method updates the Favourite content and returns the updated Favourite object */
	    @PutMapping("Favourite")
	    public ResponseEntity<Favourite> updateFavourite(@RequestBody Favourite favourite) throws RestuarantNotFoundException, RestuarantAlreadyExistsException{
...
//		public ResponseEntity<Favourite> searchByName(@PathVariable("name") String fname)
//				throws UserNotFoundException {
//	    	Favourite searchByname = favouriteService.searchByName(fname);
...
//		public ResponseEntity<List<Favourite>> searchByUserId(@PathVariable("userID") String userId)
//				throws UserNotFoundException {
//			List<Favourite> FavouriteList =favouriteService.searchByFavourites(userId); 
//			if (FavouriteList.isEmpty()) {
//				throw new UserNotFoundException();
//			}
